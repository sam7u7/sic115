...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        sqlUsuario modSql = new sqlUsuario(); //Instancia de sqlusuario
        usuario mod = new usuario();//Instancia de usuario
        //Obtener clave ingresada
        String pass = new String(jPasswordField1.getPassword());
        //Validacion completa
        /*if(!jTextField1.getText().equals("") && !pass.equals("")){ //Si no estan vacios los textbox
            mod.setUsuario(jTextField1.getText()); //Obtener el usuario ingresado
            mod.setClave(String.valueOf(jPasswordField1.getPassword())); //Obtener la clave ingresada
            if(modSql.login(mod)){ //Llamada de metodo boleano de conexion con la BD*/
